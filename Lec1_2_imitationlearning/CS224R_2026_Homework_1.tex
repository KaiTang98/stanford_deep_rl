...
\textbf{easy mode mean 959.2 std 120.8}
...
\textbf{hard mode mean 284.8 std 54.9}
...
\\
\textbf{The export randomly pick upper or lower gap to pass which make multi peak distribution and difficult to learn by mse. I tried to change the random 0 1 to only zero and it works now.}
\end{enumerate}
...
\textbf{\color{red}Include your DAgger learning curve plot here.}
...
\textbf{\color{red}Include the comparison plot and table here.}
...
\\
\textbf{\color{red}Include your explanation here.}
